export default [
    // {模板
    //     "color-scheme": "light",
    //     "primary": "#6875F5",  // 主色调，用于按钮、链接等
    //     "primary-content": "#FFFFFF",  // 主色调的对比色，用于文本等
    //     "secondary": "#E0E7FF",  // 次色调，用于次要按钮、边框等
    //     "accent": "#FFD700",  // 强调色，用于警告、通知等
    //     "neutral": "#A0AEC0",  // 中性色，用于文本、图标等
    //     "base-100": "#F7FAFC",  // 基础色，用于背景、卡片等
    //     "info": "#2563EB",  // 信息色，用于信息提示
    //     "success": "#22C55E",  // 成功色，用于成功提示
    //     "warning": "#F97316",  // 警告色，用于警告提示
    //     "error": "#EF4444",  // 错误色，用于错误提示
    //     "theme": "light",  // 主题名
    // },
{
    "color-scheme": "dark",
